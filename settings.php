...
/**
 * IDList2 enrolments plugin settings and presets.
 *
 * @package    enrol
 * @subpackage idlist2
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('enrol_idlist2_settinginfo_id', 
                                          '',
                                          get_string('enrol_idlist2_settinginfo', 'enrol_idlist2')));
}
